...
public class Gameplay extends AppCompatActivity {
    ...
    public static final String STARTPLAYER = "com.nim.playerGP";
    public static final String NUMROWS = "com.nim.numrowsGP";
    public static final String PLAYERNAME = "com.nim.usernameGP";
    public static final String DIFFICULTY = "com.nim.difficultyGP";
